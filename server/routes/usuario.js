...
app.post('/usuario', [verificaToken, verificaADM], (req, res) => {
    let body = req.body;
...
app.put('/usuario/:id', [verificaToken, verificaADM], (req, res) => {
...
app.delete('/usuario/:id', [verificaToken, verificaADM], (req, res) => {
    let id = req.params.id;
